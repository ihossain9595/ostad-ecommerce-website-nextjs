...
const Slider = () => {
  ...
  if (data) {
    return (
      <Carousel controls={false} data-bs-theme="dark" activeIndex={index} onSelect={handleSelect} className="hero-bg">
              ...
              <div className="container-fluid ">
                <div className="row px-5 justify-content-center">
                  <div className="col-12 col-lg-5 col-sm-12 col-md-5 p-5">
                    ...
                    <Link href={`/details/${item["productID"]}`} className="btn text-white btn-dark mt-1 px-5">
                      Buy Now
                    </Link>
                  </div>
                  <div className="col-12 col-lg-5 col-sm-12 col-md-5 p-5">
